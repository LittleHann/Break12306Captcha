This project is the implementation of _Discovering Sematic Meaning with Unsupervised Learning_. The task is to recognize the captcha from [China Railway Official Website](http://www.12306.cn). 
