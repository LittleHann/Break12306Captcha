...
def main(argv):
    ...
    parser.add_argument("--dbdir", action="store", default="./",
                    help="the path for db")
    ...
    old_db_path = os.path.join(args.dbdir, "db1.db")
    ...
    for _iter in range(max_iter):
        ...
        timer.tick()
        new_prob = bsddb3.hashopen(new_db_path, "n")
        ...
        old_prob.close()
        old_prob = new_prob
        old_db_path, new_db_path = new_db_path, old_db_path
